...
Timesheet.create!(:user => user, :submitted => false, :created_at => 1.week.ago, :approver => admin)
timesheet =  Timesheet.create!(:user => user, :submitted => false, :created_at => Time.now, :approver => admin)
